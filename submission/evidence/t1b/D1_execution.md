...
| IA01-06 | IA-01 | Fail | `document.title` is VI (`Gửi yêu cầu hỗ trợ \| HCMUS EMS`) while H1/labels/placeholders stay EN — mixed locale | `D1/IA01-06.png` (overlay shows title vs h1) |
...
| IA02-02 | IA-02 | Fail | Before submit: no `*` and no required legend (DOM `required` only). Asterisks appear only after failed submit | `D1/IA02-02.png` (pre-submit; 0 asterisks) |
...
| IA02-06 | IA-02 | Fail | One combined alert at bottom: “…are required.” — not per-field inline | `D1/IA02-06.png` |
...
| IA03-01 | IA-03 | Fail | On `/complaints/new`, open menu shows “Support requests” with no clear current/active highlight | `D1/IA03-01.png` |
...
| IA03-09 | IA-03 | Fail | Floating Social FAB sits over footer/content edge and competes for attention near the form actions | `D1/IA03-09.png` |
| IA03-10 | IA-03 | Pass | Open-menu drawer available | — |
| IA04-01 | IA-04 | Pass | Failed submit shows an explicit required-fields message | — |
| IA04-02 | IA-04 | Pass | Error banner readable (bottom sticky); does not cover Submit | — |
...
| IA04-10 | IA-04 | Pass | Message names the missing fields (not generic “Something went wrong”) | — |
...
| BUG-D1-02 | IA02-02 | Minor | Required markers only after first failed submit; no pre-submit legend |
| BUG-D1-03 | IA02-06 / IA02-07 | Major | Combined bottom validation alert; focus stays on Submit |
| BUG-D1-04 | IA03-03 | Minor | Missing breadcrumb on create flow |
| BUG-D1-05 | IA03-01 | Minor | Weak/absent active state for Support on create page |
| BUG-D1-06 | IA03-09 | Minor | Social FAB competes with form chrome |
